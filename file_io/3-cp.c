 ...
 * opens the specified files, reads from
 * file_from and writes to file_to until the entire
 * file is copied, handling errors
 * during file operations and closing file descriptors appropriately.
 */
