...
void execute_found_command(char **args, int command_number, char *program_name,
...
void handle_command_not_found(int found, const char *command, int command_number,
